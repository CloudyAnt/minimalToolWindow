...
class AixCefResourceHandler implements CefResourceHandler {
    ...
    public boolean processRequest(CefRequest request, CefCallback callback) {
        try {
            ...
            URL url = null;
            if (urlstr.startsWith(AixCefManager.PREFIX)) {
                String urlstrSub = urlstr.substring(AixCefManager.PREFIX.length());
